...
import { getCustomizationFile, getGlobalConfigModule } from "../initializeStoker.js"
...
export const addRecord = async (
    ...
    if (enableWriteLog) await writeLog("create", "started", record, path, docId, collectionSchema)
    ...
    try {
        ...
        await uniqueValidation("create", docId, record, collectionSchema, schema)
