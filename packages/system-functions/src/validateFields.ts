    ...
    return (async () => {
        ...
        if (after) {
            ...
            try {
                ...
                await validateRecord(operation, record as StokerRecord, collection, customization, {operation, data: after, context: {}, originalRecord: operation === "update" ? before : undefined}, schema);
