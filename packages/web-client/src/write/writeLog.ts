import { getFirestoreWrite, getGlobalConfigModule } from "../initializeStoker.js"
...
export const writeLog = async (
    ...
    const logCollection = doc(dbWrite, path.join("/"), docId, "system_write_log", `${userId}-${timestamp.valueOf()}`)
