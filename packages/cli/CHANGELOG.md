...
- Updated dependencies
    - @stoker-platform/node-client@0.5.107
...
- feat: add singleton collection restrictions
...
- feat: detect sorting fields with nullable requirement
...
- fix: force concurrently to use BASH
...
- fix: remove relations for dependent fields
