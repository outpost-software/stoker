...
We recommend setting up notifications in [Error Reporting](https://console.cloud.google.com/errors) for each production tenant in the Google Cloud console. That way you'll get emailed whenever your back end services throw an error.
