...
export default function MonthPicker({ currentMonth, onMonthChange, disabled, today }: MonthPickerProps) {
    const [currentYear, setCurrentYear] = React.useState(format(currentMonth, "yyyy"))
    const [prevMonth, setPrevMonth] = React.useState<Date | undefined>(undefined)
    ...
    React.useEffect(() => {
        if (
            ...
            isEqual(currentMonth, startOfMonth(today || startOfToday()))
        ) {
            setCurrentYear(format(startOfMonth(today || startOfToday()), "yyyy"))
        }
                            ...
                            >
                                <button
                                    ...
                                    className={cn(
                                        ...
                                        !isEqual(month, currentMonth) &&
                                            isEqual(month, startOfMonth(today || startOfToday())) &&
