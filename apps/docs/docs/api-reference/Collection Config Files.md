...
In Stoker, you define "collections" for your data. In other systems, these might be referred to as "tables", "objects" or "modules".
...
2. Guard their use by wrapping code in: 
    ...
    } else if (import.meta.env?.SSR !== false) { 
