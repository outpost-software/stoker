    ...
    return (
        <>
            <div className="w-full px-4 md:w-1/2 lg:w-1/3">
                <div className="relative min-h-[450px] 2xl:min-h-[400px] z-10 mb-10 overflow-hidden rounded-[10px] border-2 border-solid border-stroke bg-white px-8 py-10 shadow-pricing dark:border-dark-3 dark:bg-dark-2 sm:p-12 lg:px-6 lg:py-10 xl:p-[50px]">
            ...
            <section className="relative z-10 overflow-hidden bg-white pb-12 pt-16 dark:bg-dark lg:pb-[90px] lg:pt-[60px]">
                <div className="container mx-auto">
                    ...
                    <div className="-mx-4 flex flex-wrap justify-center">
                        ...
                        <PricingCard
                            active={false}
                            type="Production Tenants"
                            price="USD $79"
                            subscription="/ tenant / month"
                            description="Production tenants are free for the first 30 days. Contact us for bulk discounts."
